...
" OnTextChange
" - Check if header was changed
" - Check what changed
" - Update state
" - Update view

" Views
" - Sample: Show text to be matched agains the regexp.
" - Describe: Describe every element of the regexp.
" - Matches: Show matched text and captured groups.
" - Validate: Extract matched text and show every one.
