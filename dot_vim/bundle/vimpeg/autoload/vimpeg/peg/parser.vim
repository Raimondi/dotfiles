" Parser compiled on Thu Jan  7 18:57:16 2021,
...
call s:p.and(['backslash', 'dquote'],
      \{'id': 'escaped_dquote', 'on_match': 'vimpeg#peg#join'})
call s:p.and(['backslash', 'backslash'],
      \{'id': 'double_backslash', 'on_match': 'vimpeg#peg#join'})
call s:p.e('\',
      \{'id': 'backslash'})
...
call s:p.e('\%(\s\|\\\n\)*',
      \{'id': 'space'})
call s:p.and([s:p.maybe_one('comment'), s:p.e('\%d10')],
