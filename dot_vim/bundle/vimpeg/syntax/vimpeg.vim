...
syn match   vimpegDefMallet     /::=/ containedin=vimpegDefinition contained display
syn match   vimpegDefOr         /|/ containedin=vimpegDefinition contained display
syn match   vimpegError         /|\s*|/ containedin=vimpegDefinition contained display
syn match   vimpegError         /\%(::=\)\@<=\s*|/ containedin=vimpegDefinition contained display
...
hi link vimpegDefMallet		Conditional
hi link vimpegDefOr		Conditional
